...
class User(AbstractUser):
    ...
    birthday = models.CharField(max_length=20, default='1970-01-01')
    job_number = models.CharField(max_length=10, default='0001')

    zhengzhi_mianmao = models.CharField(max_length=10, default='群众')
    zhengzhi_time = models.CharField(max_length=20, default='1970-01-01')
    ...
    id_number = models.CharField(max_length=30, default='400000197001010000')

    xue_li = models.CharField(max_length=30, default='本科')
    school = models.CharField(max_length=30, default='青蛙大学')
    graduate_time = models.CharField(max_length=20, default='1970-01-01')
    job_join_time = models.CharField(max_length=20, default='1970-01-01')
    team_belong = models.CharField(max_length=20, default='C640')

    phone = models.CharField(max_length=30, default='1333333333333')
